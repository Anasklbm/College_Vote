...
if(isset($_GET['z']))
{
    $up=mysqli_query($dbcon,"update manage_ele set st=2 where id='".$_GET['eid']."'");
    if($up>0){
        header("location:new_candidate.php?x=1&eid=".$_GET['eid']);
    }
}
?>
<!DOCTYPE HTML>
					...
					<div class="left-nav">
						<ul>
							...
							<li><a href="new_elec.php">Manage Election</a></li>
                                                        ...
                                                        <li class="active"><a href="pub_result.php">Result</a></li>
						...
						<div class="col-lg-12">
                                                    ...
                                                    <table class="table table-bordered table-condensed table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="pub_result.php?x=1&eid=<?php echo $r_ele[0] ?>"><img src="logo/view-icon.png" /></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $i++;
							...
							<h3>FIND RESULT HERE</h3>
                                                        ...
                                                        <a href="pub_result.php?z=1&eid=<?php echo $_GET['eid'] ?>" class="btn btn-sm btn-danger">PUBLISH RESULT</a>
                                                        <?php
                                                        }
