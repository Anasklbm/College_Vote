							...
							<h3>FIND RESULT HERE</h3>
                                                        <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                            <tr>
                                                             ...
                                                             <?php
                                                             $i=1;
                                                             $sel_ele=mysqli_query($dbcon,"select * from manage_ele where col_id='$col' and dep='$dep' or dep=0 and st=2");
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td><a href="resultnow.php?eid=<?php echo $r_ele[0] ?>">Click To View Result</a></td>
                                                             </tr>
                                                             <?php
                                                             $i++;
                                                             }
